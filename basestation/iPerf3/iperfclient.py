...
if result.error:
	...
	data= {"protocol":client.protocol,"txBytes":result.bytes,"jitter":result.jitter_ms,"avgCpuLoad":result.local_cpu_total,"MB_s":result.MB_ps,"mbps":result.Mbps,"deviceIp":client.server_hostname} 
